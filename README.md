...
The kernel-level implementation of `sys_add_two_integers` looks like:
...
The executable file of the test program must be named `test_add_integers`. The code to be implemented in the test program is given as follows.

## Test program (for both functions)  

This is the user-level test program (i.e., `test_add_integers.c`) to test both functions: 
